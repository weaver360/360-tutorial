...
As you can see, It's not quite similar to the gallery we saw few minutes back in the Google Cardboard.  
...
First task is to upload the images you just clicked in the assest folder. 
...
Rename the images to something you can easily remember. (eg. a.jpg, b.jpg ....)
...
``` 
Change 1-bg to the name of image you just added to the assests folder.

And at line 31:
```
 <a-sky src="#background" rotation="0 -130 0"></a-sky>
 ```
Make sure your id in line 13 is similar to your src on your line 31, in this case, id="background" and src="assests"
...
You can refer the code below, How we link the 1st image to its 360 view
```
...
As you notice, #one is the id you use while adding the components for the assests.
...
Example: If your curved image component is ```html <a-curvedimage id="one" src="#first" transparent="true" height="3" radius="5" theta-length="40" rotation="0 280 0" position="0 0.8 0"> </a-curvedimage>```
 ...
 Start edditing gallery.html from line 105.
...
In our gallery.html
1st part is the ***header section*** of our HTML file.
Here we are just linking our aframe.js
![header](/readme_files/head.png "header")

Next comes the Setting up  ***A-scene***  
...
![Ascene](/readme_files/ascene-assets.png "Ascene/Assests")

The 1st section in a-scene is to add assets.  
We place all our assets in one place and to preload and cache assets for better performance.  
As we did in our app to add all images in the assets section.  
...
Next is Adding sky and light components and setting up camera and cursor.  
